...
const Project = ({ project, meta }) => {
    return (
        <>
            <Helmet
                title={`${project.project_title[0].text} | Galfre Valentin's portfolio`}
                ...
                meta={[
                    ...
                    {
                        property: `og:title`,
                        content: `${project.project_title[0].text} | Galfre Valentin's portfolio`,
                    },
                    {
                ...
                <ProjectBody >
                    ...
                    <WorkLink to={"https://github.com/galfrevn"}>
                        <Button className="Button--repo">
                            Find the repo in my Github
                        </Button>
                    </WorkLink>
                    <WorkLink to={"/work"} style={{ marginTop: ".5em" }} >
